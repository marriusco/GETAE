...
#define GL_COLOR_TABLE_ZZRED_SIZE_EXT         0x80DA
#define GL_COLOR_TABLE_ZZGREEN_SIZE_EXT       0x80DB
#define GL_COLOR_TABLE_ZZBLUE_SIZE_EXT        0x80DC
...
#define GL_SHAZZRED_TEXTURE_PALETTE_EXT       0x81FB
