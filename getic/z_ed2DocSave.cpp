...
void CDocSaver::SerializeBrush(Brush* pB)
{
    ...
    pB->_name[15] = 0; this->Serialize(pB->_name, 16); pB->_name[15] = 0;
    ...
    else
    {
        ...
        this->Read(nCountVx );
        CHECK_COUNT(nCountVx,1024, MKSTR("To many polygons per brush %s: Limit is 1024",pB->_name));
...
void CDocSaver::SerializePolygon(Brush* pB, Poly* pp)
{
    ...
    else
    {
        ...
        CHECK_COUNT(nCount,128, MKSTR("Too many vertexes per polygon: %s",pB->_name));
