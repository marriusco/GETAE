...
typedef char  SQAChar;  // mco
typedef short SQShort;  // mco
typedef long  SQLong;   // mco
...
#define _RT_BYTE			0x00020000 //mco
//#define _RT_SHORT			0x00040000 //mco
//#define _RT_LONG			0x00080000 //mco
...
typedef enum tagSQObjectType{
    ...
    OT_BYTE =			(_RT_BYTE|SQOBJECT_CANBEFALSE),
...
#define sq_isbyte(o) ((o)._type==OT_BYTE)//mco
