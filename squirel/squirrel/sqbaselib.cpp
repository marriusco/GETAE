...
static SQInteger default_delegate_tofloat(HSQUIRRELVM v)
{
	...
	case OT_BOOL:
        ...
        /*
	case OT_BYTE:
		v->Push(SQObjectPtr((SQFloat)(_integer(o)))); 
		break;
*/
...
SQRegFunction SQSharedState::_number_default_delegate_funcz[]={
	//{_SC("tointeger"),default_delegate_tointeger,1, _SC("n|b|q")}, //mco added q for char
    {_SC("tointeger"),default_delegate_tointeger,1, _SC("n|b")}, //mco added q for char
