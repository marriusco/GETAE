...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE Igbtview_LoadLevel_Proxy( 
    Igbtview * This,
    /* [in] */ BSTR bsURL);


void __RPC_STUB Igbtview_LoadLevel_Stub(
    IRpcStubBuffer *This,
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE Igbtview_Leave_Proxy( 
    Igbtview * This);


void __RPC_STUB Igbtview_Leave_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE Igbtview_SetProxy_Proxy( 
    Igbtview * This,
    /* [in] */ BSTR bsURL,
    /* [in] */ ULONG port);


void __RPC_STUB Igbtview_SetProxy_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
