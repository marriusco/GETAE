========================================================================
    ACTIVE TEMPLATE LIBRARY : xmoge Project Overview
========================================================================

AppWizard has created this xmoge project for you to use as the starting point for
...
_xmoge.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_xmoge.h)
        GUID definitions                                (_xmoge_i.c)
        A type library                                  (_xmoge.tlb)
        Marshaling code                                 (_xmoge_p.c and dlldata.c)
xmoge.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named xmoge.pch and a precompiled types file named StdAfx.obj.
...
xmogeps.vcproj
	...
	dlldata.c, xmoge_i.c and xmoge_p.c which are required
