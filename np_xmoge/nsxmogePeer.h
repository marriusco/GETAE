...
// ==============================
//
// CNS_Moge - xpconnect scriptable peer
// 

#ifndef __nxXmogePeer_h__
#define __nxXmogePeer_h__

#ifndef _CFG_WIN32_WIN
    #define _CFG_WIN32_WIN
#endif //
#include "nsIXmogePlugin.h"
#include "npapi.h"
...
class XScene;
class CNS_Moge : public nsIXmogePlugin,
                         public nsClassInfoMixin,
                         public nsPluginInstanceBase
{
public:
  CNS_Moge( NPP instance);
  ~CNS_Moge();
...
public:
  ...
  long LoadLevel(const char* level);
  void SetProxy(const char *bsURL, PRInt32 port);
  ...
  void       Render();
protected: 
  void      ResolveProxy(NPP instance);  
